...
- Purpose: Stores user interface preferences, paired computer connection details, and pairing credentials.
...
For questions, bug reports, privacy requests, or feature requests, use the support URL listed on AeroPoint's App Store product page.
